...
export default {
	...
	methods: {
		add() {
			...
			setInterval(async()=>{
				const f= await fetch(`https://min-api.cryptocompare.com/data/price?fsym=${newTicker.name}&tsyms=USD&api_key=5a9c19d2a6ff27a3b96a8151e570ebff83e15fe3a10d3c219c146648adab9878`)
